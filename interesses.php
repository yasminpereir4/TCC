...
<form method="post" action="cadastro_interesses.act.php?cod=$_GET[codigo]">
  <input type="hidden" name="codigo" value="<?php echo $_GET['codigo']; ?>">
  <div class="tudo">
  <div class="container">
  <div class="title"> <h1>Escolha seus interesses:</h1></div>
  <div class="botoes">
  ...
  <input onclick="mudarCor('#beb800')" type="checkbox" name="interesses[]" value="culinaria"><span class="checkmark"></span>
  </label>
  </div>
